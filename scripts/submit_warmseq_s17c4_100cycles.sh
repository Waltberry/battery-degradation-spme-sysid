...
echo "Submitting S17_C4 warm-continuation pipeline..."

jid0=$(sbatch --parsable scripts/sbatch_warmseq_s17c4_cycle0_global.sbatch)
echo "Cycle 0 global array job: ${jid0}"

jidc=$(sbatch --parsable --dependency=afterany:${jid0} --export=ALL,UN_REAL_CYCLE_INDEX=0 scripts/sbatch_warmseq_s17c4_combine.sbatch)
...
echo "Submitted S17_C4 warm-continuation chain through cycle 99."
